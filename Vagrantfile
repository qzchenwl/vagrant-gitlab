...
Vagrant.configure(2) do |config|
  ...
  config.vm.hostname = "gitlab.chenwl.com"
  ...
  # config.vm.provision "file", source: "gitlab_7.7.2-omnibus.5.4.2.ci-1_amd64.deb", destination: "gitlab_7.7.2-omnibus.5.4.2.ci-1_amd64.deb"
